@php
    ...
    $font = Helpers::getThemeSetting('google_font', 'Roboto');
    $colorTheme = Helpers::getThemeSetting('color_theme', '#1abc9c');
@endphp
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family={{ str_replace(' ', '+', $font) }}:wght@400;500;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        :root {
            ...
            ;
            --bs-base-rgb:
                {{ getHexToRGBColorCode($colorTheme) }}
            ;
            --base-2:
